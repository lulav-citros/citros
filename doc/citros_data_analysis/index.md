...
This Python package is a comprehensive solution for data query, analysis and visualization. It is designed to work with data from your simulations, uploaded in PostgreSQL database. With its extensive features, you can quickly and easily extract valuable insights from your data.

## Table of Contents
1. [Snippets](snippets_doc/data_access/snippets_batch_content.md)
    1. [Data Access](snippets_doc/data_access/snippets_batch_content.md)
        1. [Batch Content](snippets_doc/data_access/snippets_batch_content.md)
        2. [Query Data](snippets_doc/data_access/snippets_query_data.md)
        3. [Plotting](snippets_doc/data_access/snippets_plotting.md)
...
2. [Data access](data_access/index.md)
    1. [Examples](data_access/getting_started.md)
        ...
        2. [Simulations and Batches](data_access/batch_overview.md)
        3. [Batch Content](data_access/batch_content.md)
        4. [Query Data](data_access/query_data.md)
        5. [Plot Data](data_access/plot_data.md)
    2. [Documentation](documentation/access/citros_db.md)
        1. [Class CitrosDB](documentation/access/citros_db.md)
        2. [Class CitrosDict](documentation/access/citros_dict.md)
3. [Error analysis](error_analysis/index.md)
    ...
    2. [Documentation](documentation/analysis/citros_data.md)
