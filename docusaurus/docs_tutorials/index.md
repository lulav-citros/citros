...
This command will run the simulation on your machine, and save all the results under `.citros/runs/[simulation_name]` folder. The content of the [folder](/docs/citros_structure#directory-runs) will contain 
- recorded bags
