...
## Table of Contents
1. [Quick Start](../docs/cli_quickstart.md)
2. [Installation](../docs/cli_install.md)
4. [CLI Commands](../docs/cli_commands.md)
5. [CITROS Repository directory and file Structure](../docs/citros_structure.md) 
6. [Adding Functions to Parameter Setup](../docs/config_params.md)
7. [User Templates](../docs/user_templates.md#user-templates)
