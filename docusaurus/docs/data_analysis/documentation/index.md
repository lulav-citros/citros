...
## Class `Validation` {#validation.Validation}
...
## Method `std_bound_test` {#validation.Validation.std_bound_test}
...
## Method `mean_test` {#validation.Validation.mean_test}
...
## Method `std_test` {#validation.Validation.std_test}
...
## Method `sid_test` {#validation.Validation.sid_test}
...
## Method `norm_test` {#validation.Validation.norm_test}
...
## Method `set_tests` {#validation.Validation.set_tests}
...
**[Validation.std_bound_test()](#validation.Validation.std_bound_test "validation.Validation.std_bound_test")**, **[Validation.mean_test()](#validation.Validation.mean_test "validation.Validation.mean_test")**, **[Validation.std_test()](#validation.Validation.std_test "validation.Validation.std_test")**, **[Validation.sid_test()](#validation.Validation.sid_test "validation.Validation.sid_test")**, **[Validation.norm_test()](#validation.Validation.norm_test "validation.Validation.norm_test")**
